...
public class RenderChatBombPrimed extends Render<EntityChatBombPrimed> {

    public static final Factory FACTORY = new Factory();

    public RenderChatBombPrimed(RenderManager renderManagerIn)
    {
    ...
    public static class Factory implements IRenderFactory<EntityChatBombPrimed> {

        @Override
        public Render<? super EntityChatBombPrimed> createRenderFor(RenderManager manager) {
            return new RenderChatBombPrimed(manager);
        }
